            ...
            {stats.map((stat, index) => (
              ...
              >
                ...
                <Text 
                  fontSize={["3xl", "4xl"]} 
                  fontWeight="bold" 
                  color={stat.accent ? "cyan.300" : "white"}
                  mb={2}
                >
                  {stat.number}
                </Text>
              ...
              <VStack spacing={6} align="stretch">
                ...
                >
                  <HStack spacing={4} mb={3}>
                    <FontAwesomeIcon icon={faShield} color="#22d3ee" />
                ...
                >
                  <HStack spacing={4} mb={3}>
                    <FontAwesomeIcon icon={faStar} color="#22d3ee" />
                    <Text fontSize="lg" fontWeight="600" color="cyan.200">
                      The Solution
                    </Text>
                  </HStack>
